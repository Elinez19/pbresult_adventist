        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:text-left text-center">
          ...
          <div className="">
            <Fade direction="up" delay={400} cascade damping={0.1} triggerOnce>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold mb-5 text-lightgrey ">
                Adventists Schools <br />
                <span className="text-[#135352]">Result Management.</span>
              </h1>
            </Fade>
            <Fade direction="up" delay={800} cascade damping={0.1} triggerOnce>
              <p className="text-base sm:text-lg lg:text-xl text-grey font-normal mb-10 leading-relaxed">
                Simplifying academic record-keeping for schools across
                Adventists Schools.
                <span className="block">
                  Ensuring efficient communication between schools, students,
                  and the parents.
                </span>
              </p>
            </Fade>
