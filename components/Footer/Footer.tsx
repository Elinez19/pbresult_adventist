...
const products: ProductType[] = [
  {
    id: 1,
    link: ["About Us", "Features", "Why Adventist Education", "Contact Us"],
  },
  {
    id: 2,
    link: ["Support", "FAQ", "Guides", "Visit Us"],
  },
];

const Footer = () => {
  return (
    <div className="bg-[#135352]">
      <div className="mx-auto max-w-7xl pt-1 px-2 sm:px-4 lg:px-8">
        ...
        <div className="my-14 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          ...
          <div className="col-span-1">
            <Image
              src={"/adventist-logo.jpeg"}
              alt="logo"
              className="pb-6"
              width={120}
              height={100}
            />
            <p className="text-white text-base mb-4">Adventist Education</p>
            <div className="flex gap-4">
              <Link
                href="https://www.facebook.com/purplebeetech"
                className="fb-icons"
              >
              ...
              <Link
                href="https://www.instagram.com/purplebeetech/"
                className="icons"
              >
              ...
              <ul>
                {product.link.map((link: string, index: number) => (
                  <li key={index} className="mb-5">
                    <Link
                      href="/"
                      className="text-white text-base font-normal mb-2 space-links"
                    >
                      {link}
                    </Link>
                  </li>
        ...
        <div className="py-4 lg:flex items-center justify-center border-t border-t-gray-300">
          <h4 className="text-white text-sm text-center lg:text-start font-normal">
            {new Date().getFullYear()} Adventist Education. All Rights Reserved
            by{" "}
            <Link
