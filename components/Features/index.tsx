...
const cardData: CardData[] = [
  {
    ...
    paragraph:
      "A guide to setting up your school profile, managing accounts, and overseeing student records.",
    cta1: "Admin Login",
  ...
  },
  {
    ...
    paragraph:
      "Discover how to manage student grades, input results efficiently, and much more.",
    cta1: "Teacher Login",
  ...
  },
  {
    ...
    paragraph:
      "Access your results, track academic progress, and understand how to use the portal.",
    cta1: "Student Login",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {cardData.map((card, i) => (
            <div
              key={i}
              className="bg-[#f3ebdd] rounded p-8 flex flex-col justify-between"
            >
              ...
              <Link href={card.link1} passHref legacyBehavior>
                <a className="text-white bg-[#135352] transition-all text-center font-medium py-2 px-4 rounded block w-40">
                  {card.cta1}
                </a>
              </Link>
              ...
              <button
                ...
                className="text-[#135352] underline text-md font-medium mt-4 block text-left"
              >
                {card.cta2}
              </button>
            </div>
