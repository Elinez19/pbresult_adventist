...
const cardData: CardData[] = [
  {
    ...
    paragraph: "All schools can upload and manage student results efficiently.",
    imgSrc: "/result-management.png", // Replace with your actual image path
  },
  {
    title: "Real-time Access",
    paragraph:
      "Students and parents can access results directly, ensuring transparency and engagement.",
    imgSrc: "/real-time-access.png", // Replace with your actual image path
  },
  {
    title: "Schoolwide Monitoring",
    paragraph:
      "Provides the School Administrators with detailed insights on academic performance across all schools.",
    imgSrc: "/state-wide.png", // Replace with your actual image path
  },
  {
    title: "User-friendly Interface",
    paragraph:
      "Simple and intuitive design for school administrators, teachers, and parents",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {cardData.map((card, i) => (
            <div
              key={i}
              className="bg-white shadow-lg rounded-lg overflow-hidden p-5 flex flex-col"
            >
              {/* Title and paragraph */}
